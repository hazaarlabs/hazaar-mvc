...
<div class="container">
    ...
    <div class="row py-3">
        ...
        <div class="col-lg-4">
            ...
            <p>
                If you need any help or support developing with Hazaar then feel free to drop by the
                <a href="https://hazaar.slack.com">Hazaar Labs Slack</a> and ask your
                questions. The Hazaar support staff or other users will be able to help you out.
            </p>
