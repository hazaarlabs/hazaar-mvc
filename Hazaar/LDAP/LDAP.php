...
class LDAP {
     ...
     * LDAP constructor.
     *
     * @param string $host If you are using OpenLDAP 2.x.x you can specify a URL instead of the hostname. To use LDAP
     ...
     *
     * @param int $version The LDAP protocol version used to communicate with the server.
     */
     ...
     *
     * @param null $attributes An array of the required attributes, e.g. array("mail", "sn", "cn"). Note that the "dn"
     ...
     *
     * @param array $entry An array that specifies the information about the entry. The values in the entries are
