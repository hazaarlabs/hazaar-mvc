...
abstract class Strict implements \ArrayAccess, \Iterator {
    ...
    /**
     * @param Undefined values will be ignored.  This is checked first.
     */
    protected $ignore_undefined = TRUE;

    /**
     * @param Undefined values will be automatically added and their type will be detected
     */
    protected      $allow_undefined   = FALSE;

    static private $known_types       = array(
        'boolean',
        'bool',
        'integer',
        'int',
