...
function is_boolean($value) {
    ...
    $accepted = array('t', 'true', 'f', 'false', 'y', 'yes', 'n', 'no', 'on', 'off');
 ...
 *
 * @param $array The array to seek
 *
 * @param $count The number of elements to seek forward
 */
 ...
 * @param       array $query (optional) Array of parameters to send.  ie: the stuff after the '?'.  Uses
