...
class Application {
     ...
     *
     * @param       string $configFile The application configuration file to use.  eg: application.ini
     */
    ...
    public function runStdin() {
        ...
        $protocol = new \Hazaar\Warlock\Protocol($warlock->sys->id, $warlock->server->encoded);
     ...
     * @since       1.0.0
     *
     * @param       $location string The URL you want to redirect to
     *
     * @param       $args     array An optional array of parameters to tack onto the URL
     *
     * @param       $save_url boolean Optionally save the URL so we can redirect back.  See: Application::redirectBack()
     */
