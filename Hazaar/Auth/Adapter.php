...
abstract class Adapter implements Adapter\_Interface, \ArrayAccess {
    ...
    static public $credential_encryption       = 'none';

    static public $credential_encryption_count = 1;

    static public $autologin_period            = 3600;

    static public $autologin_cookie            = 'siteAuth';

    function __construct() {

        $this->session = new \Hazaar\Session(array('use_pragma' => FALSE));
