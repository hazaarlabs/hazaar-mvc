...
class HelpModule extends Module
{
    ...
    {
        $this->addGlobalOption(long: 'env', short: 'e', description: 'The environment to use.  Overrides the APPLICATION_ENV environment variable', default: 'development', valueType: 'env');
