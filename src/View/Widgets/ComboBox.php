...
class ComboBox extends Widget {
    ...
    /**
     * @detail      Initialise a ComboBox widget
     *
    ...
    /**
     * @detail      Sets or gets the item search mode. When the user types into the edit field, the jqxComboBox widget
     *              tries to find the searched item using the entered text and the selected search mode.
     *
     *              Possible Values:
     *              * 'none'
     *              * 'contains'
    ...
    public function searchMode($value) {
        ...
        return $this->set('selectedIndex', $value, 'string');

    }

    /**
     * @detail      Sets or gets the whether the 'autoComplete' feature is enabled or disabled. When this feature is
     *              enabled, the jqxComboBox displays in the popup listbox, only the items that match the searched text.
     *
     * @since       1.1
     *
     * @param       int $value The value to set
    ...
    public function autoComplete($value) {
        ...
        return $this->set('selectedIndex', $value, 'bool');

    }

    /**
     * @detail      Determines whether the items displayed in the popup come from a remote data source. When this
     *              property is set to true, the jqxComboBox calls the 'search' callback function when the user types
     ...
     * @return      \\Hazaar\\Widgets\\ComboBox
     */
    public function remoteAutoComplete($value) {
    ...
    /**
     * @detail      Determines the delay between two keystrokes. The search callback function is called on timeout. The
     ...
     * @return      \\Hazaar\\Widgets\\ComboBox
     */
    public function remoteAutoCompleteDelay($value) {
    ...
    /**
     * @detail      Determines the minimum number of characters that need to be entered by the user for search in remote
     *              data source when remoteAutoComplete property is set to true.
     *
     * @since       1.1
     *
     * @param       int $value The value to set
    ...
    /**
     * @detail      Callback function which is called when the 'remoteAutoComplate' property is set to true and the user
     *              types into the ComboBox's input field.
     *
     * @since       1.1
     *
     * @param       int $value The value to set
    ...
    public function search($value) {
        ...
        return $this->set('selectedIndex', $value);
    ...
    /**
     * @detail      Sets or gets the input field's place holder.
     *
     * @since       1.1
     *
     * @param       string $value The value to set
    ...
    /**
     * @detail      Sets or gets the height of the jqxComboBox's ListBox displayed in the widget's DropDown.
     *
     * @since       1.1
     *
     * @param       int $value The value to set
    ...
    /**
     * @detail      Sets or gets the width of the jqxComboBox's ListBox displayed in the widget's DropDown.
     *
     * @since       1.1
     *
     * @param       int $value The value to set
    ...
    /**
     * @detail      Sets or gets whether the height of the jqxComboBox's ListBox displayed in the widget's DropDown
    ...
    /**
     * @detail      Sets or gets the height of the jqxComboBox Items. When the itemHeight == - 1, each item's height
    ...
    /**
     * @detail      Callback function which is called when the selected item is rendered. By using the renderSelectedItem
     *              function, you can customize the displayed text in the ComboBox's input field.
     *
     * @since       1.1
     *
     ...
     * @return      \\Hazaar\\Widgets\\ComboBox
     */
    public function renderSelectedItem($value) {

        return $this->set('renderSelectedItem', $value);
    ...
    /**
     * @detail      Adds a new item to the jqxComboBox. Returns 'true', if the new item is added or false if the item
     *              is not added.
     *
     * @since       1.1
     *
    ...
    /**
     * @detail      Inserts a new item to the jqxComboBox.
     *
     * @since       1.1
     *
     * @param       string $item
    ...
    /**
     * @detail      Removes an item from the jqxComboBox. Index is a number of the item to remove
     *
     * @since       1.1
     *
     * @param       int $index
    ...
    /**
     * @detail      Ensures that an item is visible. index is number. When necessary, the jqxComboBox scrolls to the
    ...
    /**
     * @detail      Sets the content of the ComboBox.
     *
     * @since       1.1
     *
