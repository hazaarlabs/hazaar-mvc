...
class Html extends \Hazaar\View\Helper {
     ...
     */
    public function block($type, $content = NULL, $params = [], $close = TRUE) {
     ...
     */
    public function inline($type, $params = []) {
    ...
    public function group($params = []) {
        ...
        return new \Hazaar\Html\Group(func_get_args($params = []));
     ...
     */
    public function doctype($html = TRUE, $level = 5, $strict = TRUE, $params = []) {
     ...
     * @return      \\Hazaar\\Html\\A
     */
    public function a($href = null, $content = NULL, $params = []) {
     ...
     */
    public function abbr($content, $params = []) {
     ...
     */
    public function address($content, $params = []) {
     ...
     */
    public function area($href, $coords, $params = []) {
     ...
     */
    public function article($content, $params = []) {
     ...
     */
    public function aside($content, $params = []) {
     ...
     */
    public function audio($autoplay = FALSE, $controls = TRUE, $params = []) {
     ...
     */
    public function b($content = null, $params = []) {
     ...
     */
    public function base($href, $target = NULL, $params = []) {
     ...
     */
    public function bdi($content, $params = []) {
     ...
     */
    public function bdo($content, $dir = NULL, $params = []) {
     ...
     */
    public function blockquote($content, $params = []) {
     ...
     */
    public function body($content, $params = []) {
     ...
     */
    public function button($label, $type = 'button', $params = []) {
     ...
     */
    public function canvas($name, $params = []) {
     ...
     */
    public function caption($content, $align = NULL, $params = []) {
     ...
     */
    public function cite($content, $params = []) {
     ...
     */
    public function code($content, $params = []) {
     ...
     */
    public function datalist($items = [], $name = NULL, $params = []) {
     ...
     */
    public function dd($content, $params = []) {
     ...
     */
    public function del($content, $params = []) {
     ...
     */
    public function details($content, $summary = NULL, $params = []) {
     ...
     */
    public function dfn($content, $params = []) {
     ...
     */
    public function dialog($content, $open = FALSE, $params = []) {
     ...
     */
    public function div($content = NULL, $params = []) {
     ...
     */
    public function dl($items = [], $params = []) {
     ...
     */
    public function dt($content, $params = []) {
     ...
     */
    public function em($content, $params = []) {
     ...
     */
    public function embed($src, $params = []) {
     ...
     */
    public function fieldset($content = NULL, $params = []) {
     ...
     */
    public function figcaption($content, $params = []) {
     ...
     */
    public function figure($image, $caption = NULL, $params = []) {
     ...
     */
    public function footer($content, $params = []) {
     ...
     */
    public function form($content = null, $params = []) {
     ...
     */
    public function h1($content = null, $params = []) {
     ...
     * @return      \\Hazaar\\Html\\H1
     */
    public function h2($content  = null, $params = []) {
     ...
     */
    public function h3($content = null, $params = []) {
     ...
     */
    public function h4($content = null, $params = []) {
     ...
     */
    public function h5($content = null, $params = []) {
     ...
     */
    public function h6($content = null, $params = []) {
     ...
     */
    public function head($content = null, $params = []) {
     ...
     */
    public function header($content, $params = []) {
     ...
     */
    public function hgroup($content, $params = []) {
     ...
     */
    public function html($content = null, $params = []) {
     ...
     */
    public function i($content = null, $params = []) {
     ...
     */
    public function iframe($content = null, $params = []) {
     ...
     */
    public function img($src, $alt = NULL, $params = []) {
     ...
     * @return      \\Hazaar\\Html\\Img
     */
    public function image($filename, $text = NULL, $params = []) {
     ...
     */
    public function input($type, $name, $value = NULL, $params = []) {
     ...
     */
    public function ins($content, $params = []) {
     ...
     */
    public function kbd($content, $params = []) {
     ...
     */
    public function keygen($name, $params = []) {
     ...
     */
    public function label($content, $for = NULL, $params = []) {
     ...
     */
    public function legend($content, $params = []) {
     ...
     */
    public function li($content = NULL, $params = []) {
     ...
     */
    public function link($href, $rel = NULL, $type = NULL, $params = []) {
     ...
     */
    public function map($content = null, $name = null, $params = []) {
     ...
     */
    public function mark($content, $params = []) {
     ...
     */
    public function meta($content, $name = NULL, $params = []) {
     ...
     */
    public function meter($content, $value = NULL, $min = NULL, $max = NULL, $params = []) {
     ...
     */
    public function nav($content = NULL, $params = []) {
     ...
     */
    public function noscript($content = NULL, $params = []) {
     ...
     */
    public function object($data, $type = NULL, $params = []) {
     ...
     */
    public function ol($items = NULL, $params = []) {
     ...
     */
    public function optgroup($label = null, $options = [], $value = null, $params = [], $use_options_as_index = true) {
     ...
     */
    public function option($label, $value = NULL, $params = []) {
     ...
     */
    public function output($name, $for, $params = []) {
     ...
     */
    public function p($content = null, $params = []) {
     ...
     */
    public function param($name, $value, $params = []) {
     ...
     */
    public function pre($content = null, $params = []) {
     ...
     */
    public function progress($value, $max = 100, $params = []) {
     ...
     */
    public function q($content = null, $params = []) {
     ...
     */
    public function rp($content, $params = []) {
     ...
     */
    public function rt($content, $params = []) {
     ...
     */
    public function ruby($content, $params = []) {
     ...
     */
    public function s($content = null, $params = []) {
     ...
     */
    public function samp($content, $params = []) {
     ...
     */
    public function script($content = NULL, $type = NULL, $params = []) {
     ...
     */
    public function section($content = null, $params = []) {
     ...
     */
    public function select($name, $options = [], $value = NULL, $params = [], $use_options_index_as_value = true) {
     ...
     */
    public function small($content = null, $params = []) {
     ...
     */
    public function source($source, $type = null, $mime_prefix = null, $params = []) {
     ...
     */
    public function span($content = NULL, $params = []) {
     ...
     */
    public function strong($content, $params = []) {
     ...
     */
    public function style($selector = NULL, $elements = []) {
     ...
     */
    public function sub($content, $params = []) {
     ...
     */
    public function summary($content, $params = []) {
     ...
     */
    public function sup($content, $params = []) {
     ...
     */
    public function table($content = null, $params = []) {
     ...
     */
    public function tbody($content = null, $params = []) {
     ...
     */
    public function td($content = null, $params = []) {
     ...
     */
    public function textarea($value = NULL, $params = []) {
     ...
     */
    public function tfoot($content = null, $params = []) {
     ...
     */
    public function th($content = null, $params = []) {
     ...
     */
    public function thead($content = null, $params = []) {
     ...
     */
    public function tr($content = null, $params = []) {
     ...
     */
    public function u($content = null, $params = []) {
     ...
     */
    public function ul($content = null, $params = []) {
     ...
     */
    public function video($autoplay = FALSE, $controls = FALSE, $params = []) {
     ...
     */
    public function wbr($content, $params = []) {
