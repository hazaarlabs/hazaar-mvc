...
+function (a) {
    ...
    b.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0}, b.prototype.cycle = function (b) {
        ...
        if (!e.length) {
            if (!this.options.wrap)return null;
        ...
        if (!e.hasClass("active")) {
            if (this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid", function () {
                ...
                if (this.$element.trigger(j), j.isDefaultPrevented())return null;
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                if (c && c.length) {
                    ...
                    if (d && d.transitioning)return null;
    ...
    f.prototype.toggle = function (d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
                if ("ontouchstart"in document.documentElement && !f.closest(".navbar-nav").length && a('<div class="dropdown-backdrop"/>').insertAfter(a(this)).on("click", b), f.trigger(d = a.Event("show.bs.dropdown")), d.isDefaultPrevented())return null;
    ...
    b.DEFAULTS = {backdrop: !0, keyboard: !0, show: !0}, b.prototype.toggle = function (a) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            }, this)), d && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !b)return null;
    ...
    b.DEFAULTS = {animation: !0, placement: "top", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1}, b.prototype.init = function (b, c, d) {
        ...
        if (this.hasContent() && this.enabled) {
            if (this.$element.trigger(b), b.isDefaultPrevented())return null;
            var c = this.tip();
